    ...
    for category in os.listdir(frame_dir):
        ...
        for frame_file in os.listdir(category_dir):
            ...
            if os.path.isdir(frame_root_folder):
                ...
                threads.append(threadFun(frame2face, (
                    func_path, predictor_path, frame_root_folder, face_root_folder, cnn_face_detector)))
...
if __name__ == '__main__':
    ...
    # main(frame_dir_train_afew, face_dir_train_afew, n_thread=16)
    main(frame_dir_val_afew, face_dir_val_afew, n_thread=16)
